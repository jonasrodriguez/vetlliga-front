...
## [1.8.1] - 2026-07-15
### Changed
- Updated desparasitacion filtro literal
- Format date adds 2 digits to day and month

---

## [1.8.1] - 2026-07-11
### Fix
- Fix missing file "readFile"

---

## [1.8.0] - 2026-07-11
### Added
- Avatar management logic implemented

---

## [1.7.0] - 2026-07-03
### Changed
- Removed animal filters (from to) from vacunas, test & desparasitasiones

---

## [1.6.1] - 2025-10-31
### Fixed
- Datepickers will allow manual input without resetting
- Removed uncontroller warning on combobox
